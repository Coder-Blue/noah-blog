...
Ý muốn của tôi ở đây không hề muốn đả động gì đến tư tưởng của các bạn lập trình web hay ăn gạch đá chỉ trích, mà là chỉ muốn khuyến khích thị trường sôi động hơn, lập trình viên có nhiều lựa chọn hơn, đỡ vất vả hơn, hoặc chỉ đờn giản là có thứ để nghịch.

![SveltePost](https://i.ibb.co/X4mq836/svelte.png)

## Svelte là gì?

Svelte là một thư viện UI JavaScript đơn giản được tạo ra bởi Rich Harris, hiện có thể sử dụng mặc định với Vite, một build tool tốc độ và hiệu năng cao. Thậm chí nếu bạn muốn một meta-framework như NextJS với React thì Svelte có SvelteKit.
...
- Svelte xuất bundle ra khá nhẹ, và tốc độ rerender cao
